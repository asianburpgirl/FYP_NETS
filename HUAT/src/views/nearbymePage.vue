...
export default defineComponent({
        ...
        buttons: [
          ...
          },
          {
            ...
            handler: () => {
              ...
              let url = "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5001/bookings";
              axios
                .post(url, {
                ...
                .then((response) => {
                  // deduct money
                  url =
                    "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5001/updateBalance/" +
                  ...
                  axios
                    ...
                    .then((response) => {
                      ...
                      url =
                        "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5004/lotAdj/" + carparkID + "/2/1";
                      axios
                        .get(url)
                        .then((response) => {
                          url = "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5006/deduct";
                          axios
                            .post(url, {
  ...
  methods: {
    getCarparksMonthlySubs() {
      const url = "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5003/chosenCarparks";
      axios
        .get(url)
        .then((response) => {
    ...
    getUserCommonCarparks() {
      const url =
        "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5001/commonCarparks/" +
    ...
    loaduser() {
      ...
      const url =
        "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5002/getBalance/" + parseInt(this.userData.userID);
      axios
        .get(url)
        .then((response) => {
    ...
    checkUserHasPlan() {
      let url =
        "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5005/subs/" +
        parseInt(this.userData.userID) +
        "&" +
        1;
      axios
                                    ...
                                    .then((response) => {
                                      ...
                                      axios
                                        ...
                                        .then((response) => {
                                          ...
                                          const url =
                                            "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5004/getCarparkPrice/1";
                                          axios
                                            .get(url)
                                            .then((response) => {
                                              let fee = 0;
                                              ...
                                              /////////// 2
                                              const url =
                                                "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5004/getCarparkPrice/2";
                                              axios
                                                .get(url)
                                                .then((response) => {
                                                  let fee = 0;
                                                  ...
                                                  ///////////////3
                                                  const url =
                                                    "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5004/getCarparkPrice/3";
                                                  axios
                                                    .get(url)
                                                    .then((response) => {
                                                      let fee = 0;
                                                      ...
                                                      /////////// 4
                                                      const url =
                                                        "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5004/getCarparkPrice/4";
                                                      axios
                                                        .get(url)
                                                        .then((response) => {
                                                          let fee = 0;
                                                          ...
                                                          /////////// 5
                                                          const url =
                                                            "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5004/getCarparkPrice/5";
                                                          axios
                                                            .get(url)
                                                            .then(
                                                              (response) => {
                                                                ...
                                                                ///////////////6
                                                                const url =
                                                                  "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5004/getCarparkPrice/6";
                                                                axios
                                                                  .get(url)
                                                                  .then(
                                                                    (
                                                                      ...
                                                                      ///////////////7
                                                                      const url =
                                                                        "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5004/getCarparkPrice/7";
                                                                      axios
                                                                        .get(
                                                                          url
                                                                        )
                                                                        .then(
                                                                          (
                                                                            ...
                                                                            ///////////////8
                                                                            const url =
                                                                              "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5004/getCarparkPrice/8";
                                                                            axios
                                                                              .get(
                                                                                url
                                                                              )
