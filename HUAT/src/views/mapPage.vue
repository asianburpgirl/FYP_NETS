...
export default defineComponent({
  ...
  methods: {
    loaduser() {
      ...
      const url =
        "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5002/getBalance/" + parseInt(userData.userID);
      axios
        .get(url)
        .then((response) => {
    ...
    //     // updateBalance
    //     const url = "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5001/updateBalance/" + bookingID;
    //     axios
    //         .put(url, {
    //             bookingID: bookingID,
    //         })
                                ...
                                .then((response) => {
                                  ...
                                  axios
                                    ...
                                    .then((response) => {
                                      ...
                                      // const url = "http://ec2-3-26-37-251.ap-southeast-2.compute.amazonaws.com :5004/getCarparkPrice/1"
                                      // axios
                                      //     .get(url)
                                      //     .then((response) => {
                                    });
